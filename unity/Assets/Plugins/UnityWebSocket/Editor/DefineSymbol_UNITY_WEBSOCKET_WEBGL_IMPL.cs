...
{
    public static class DefineSymbol_UNITY_WEBSOCKET_WEBGL_IMPL
    {
        public const string SYMBOL_NAME = "UNITY_WEBSOCKET_WEBGL_IMPL";

        public const string MENU_TITLE = "Tools/Define Symbol/UnityWebSocket/" + SYMBOL_NAME;
