...
public static class DefineSymbol_PINUS_LOG
{
    public const string SYMBOL_NAME = "PINUS_LOG";

    public const string MENU_TITLE = "Tools/Define Symbol/Pinus/" + SYMBOL_NAME;
