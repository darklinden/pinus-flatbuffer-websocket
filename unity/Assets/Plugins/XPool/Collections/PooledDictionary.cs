...
{
    /// <summary>
    /// Used internally to control behavior of insertion into a <see cref="XDictionary{TKey, TValue}"/>.
    /// </summary>
    ...
    /// <remarks>
    /// A <see cref="XDictionary{TKey,TValue}"/> can support multiple readers concurrently, as long as the collection is not modified. 
    ...
    public class XDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>, IDisposable
    {
        ...
        /// </summary>
        public XDictionary() : this(0, ClearMode.Auto, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(ClearMode clearMode) : this(0, clearMode, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(int capacity) : this(capacity, ClearMode.Auto, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(int capacity, ClearMode clearMode) : this(capacity, clearMode, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(IEqualityComparer<TKey> comparer) : this(0, ClearMode.Auto, comparer) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(int capacity, IEqualityComparer<TKey> comparer) : this(capacity, ClearMode.Auto, comparer) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(ClearMode clearMode, IEqualityComparer<TKey> comparer) : this(0, clearMode, comparer) { }
        ...
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(IDictionary<TKey, TValue> dictionary) : this(dictionary, ClearMode.Auto, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(IDictionary<TKey, TValue> dictionary, ClearMode clearMode) : this(dictionary, clearMode, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) : this(dictionary, ClearMode.Auto, comparer) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(IDictionary<TKey, TValue> dictionary, ClearMode clearMode, IEqualityComparer<TKey> comparer) :
            this(dictionary?.Count ?? 0, clearMode, comparer)
        {
            ...
            if (dictionary is XDictionary<TKey, TValue> pooled)
            {
        ...
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection)
            : this(collection, ClearMode.Auto, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, ClearMode clearMode)
            : this(collection, clearMode, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey> comparer)
            : this(collection, ClearMode.Auto, comparer) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, ClearMode clearMode, IEqualityComparer<TKey> comparer) :
        ...
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(IEnumerable<(TKey key, TValue value)> collection)
            : this(collection, ClearMode.Auto, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(IEnumerable<(TKey key, TValue value)> collection, ClearMode clearMode)
            : this(collection, clearMode, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(IEnumerable<(TKey key, TValue value)> collection, IEqualityComparer<TKey> comparer)
            : this(collection, ClearMode.Auto, comparer) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public XDictionary(IEnumerable<(TKey key, TValue value)> collection, ClearMode clearMode, IEqualityComparer<TKey> comparer)
...
#pragma warning restore IDE0059
        ...
        public struct Enumerator : IEnumerator<KeyValuePair<TKey, TValue>>, IDictionaryEnumerator
        {
            ...
            internal Enumerator(XDictionary<TKey, TValue> dictionary, int getEnumeratorRetType)
            {
        ...
        public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
        {
            ...
            public KeyCollection(XDictionary<TKey, TValue> dictionary)
            {
            ...
            public struct Enumerator : IEnumerator<TKey>, IEnumerator
            {
                ...
                internal Enumerator(XDictionary<TKey, TValue> dictionary)
                {
                    _dictionary = dictionary;
                    _version = dictionary._version;
                    _index = 0;
        ...
        public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
        {
            ...
            public ValueCollection(XDictionary<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
                    throw new ArgumentNullException(nameof(dictionary));
