...
public static class DefineSymbol_XPOOL_LOG
{
    public const string SYMBOL_NAME = "XPOOL_LOG";

    public const string MENU_TITLE = "Tools/Define Symbol/XPool/" + SYMBOL_NAME;
