...
rm -rf ../docker-services/$IMAGE_NAME/$IMAGE_NAME*.tar.gz
mkdir -p ../docker-services/$IMAGE_NAME

echo "Move image to docker-services/$IMAGE_NAME/$IMAGE_NAME.tar.gz"
mv ./$IMAGE_NAME.tar.gz ../docker-services/$IMAGE_NAME/$IMAGE_NAME.tar.gz
