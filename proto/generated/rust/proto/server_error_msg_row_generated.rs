...
impl Serialize for ServerErrorMsgRow<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("ServerErrorMsgRow", 2)?;
      s.serialize_field("err_code", &self.err_code())?;
      if let Some(f) = self.err_msg() {
        s.serialize_field("err_msg", &f)?;
      } else {
        s.skip_field("err_msg")?;
      }
    s.end()
  }
}

pub struct ServerErrorMsgRowBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> ServerErrorMsgRowBuilder<'a, 'b> {
  #[inline]
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> ServerErrorMsgRowBuilder<'a, 'b> {
