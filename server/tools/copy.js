...
const src_folder = path.join(__dirname, '..', 'config');
const des_folder = path.join(__dirname, '..', 'dist', 'config');

fs.mkdirSync(des_folder, { recursive: true });
